        ...
        <div className="flex items-center gap-4 group cursor-pointer">
          ...
          <div>
            <h1 className="text-2xl font-black text-white tracking-tighter leading-none flex items-center gap-1">
              GLOBAL<span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400">STREAM</span>
            </h1>
            <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Global Cross-Reference Engine</span>
          </div>
        </div>
